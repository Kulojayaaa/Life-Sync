  ...
  return (
    <AppLayout>
      <div className="space-y-8">
        <PageHeader title="Dashboard" subtitle={`Your LifeSync overview for ${currentMonth}`} icon={LayoutDashboard} primaryAction={<Button onClick={() => openQuickAdd()}>Add transaction</Button>} />
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Card className="border-primary/20 bg-gradient-to-r from-primary/5 to-accent/5">
              ...
              <CardContent>
                <p className="mb-5 text-4xl font-bold tracking-tight text-primary">{formatCurrency(Math.max(stats.dailyLimit - stats.todaySpending, 0))}</p>
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-destructive">{formatCurrency(stats.todaySpending)}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-warning">{stats.pendingBills}</p>
                  </div>
                  <div>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-destructive">{formatCurrency(stats.debtBalance)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">EMI Outstanding</p>
                    <p className="text-2xl font-bold text-warning">{formatCurrency(stats.totalEmiLiability)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Savings</p>
                    <p className="text-2xl font-bold text-info">{formatCurrency(stats.savingsCurrentTotal)}</p>
